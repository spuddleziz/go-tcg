...
type PasswordEmbed struct {
	...
	Hash     string `optional:"" env:"HASH" default:"sedutil-dta" enum:"sedutil-dta,sedutil-sha512,hex,hex-file,file,sedutil-dta-file,sedutil-sha512-file" help:"Either use sedutil-dta (sha1) or sedutil-sha512 for hashing"`
}
